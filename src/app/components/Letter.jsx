...
export default function Letter() {
    ...
    const letterText = `Happy Birthday! 🎉
Today’s all about celebrating you—the laughs you bring, the way you light up any room, and all the memories we’ve already packed in.

You have this amazing knack for making everyone around you smile and feel at ease. Seriously, the world’s a brighter place with you in it.

Here’s to more fun times, more random adventures, and a year full of good vibes.
